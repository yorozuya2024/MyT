			...
			$objWriter->startElement('c:ser');
				...
				if ($plotSeriesCategory && ($plotSeriesCategory->getPointCount() > 0)) {
					...
					if (($groupType === PHPExcel_Chart_DataSeries::TYPE_BUBBLECHART) ||
						...
						$this->_writePlotSeriesValues($pSheet, $plotSeriesCategory, $objWriter, $groupType, 'str');
					$objWriter->endElement();
				}
				...
				if ($plotSeriesValues) {
					...
					if (($groupType === PHPExcel_Chart_DataSeries::TYPE_BUBBLECHART) ||
						...
						$this->_writePlotSeriesValues($pSheet, $plotSeriesValues, $objWriter, $groupType, 'num');
					$objWriter->endElement();
				}
