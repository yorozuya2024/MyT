...
foreach ($model->customSearch(false, true)->getData() as $singleCharge)
{
...
<h1><?php echo Yii::t('nav', 'Manage Charges'); ?></h1>
...
$this->widget('ext.EChargeProjectDetailsExcelView', array(
    ...
    'columns' => array(
        array(
            'name' => 'project_id',
            'filter' => CHtml::activeDropDownList($model, 'project_id', CHtml::listData(Project::model()->findAllHierarchical($this->getProjectsByUserCriteria(Yii::app()->user->id)), 'id', function($project) {
