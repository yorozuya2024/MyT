...
<div class="row">
  <?php echo $form->labelEx($model, 'load_cost'); ?>
  <?php echo $form->numberField($model, 'load_cost', array('min' => 0, 'step' => 0.5)); ?>
  <?php echo $form->error($model, 'load_cost'); ?>
</div>

<div class="row">
  <?php echo $form->labelEx($model, 'daily_hours'); ?>
  <?php echo $form->numberField($model, 'daily_hours', array('min' => 0, 'step' => 0.5)); ?>
  <?php echo $form->error($model, 'daily_hours'); ?>
</div>
